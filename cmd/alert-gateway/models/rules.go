...
type Rules struct {
	...
	AlertN      string `orm:"column(alertn);size(1023)" json:"alertn"`
	Cluster     string `orm:"column(cluster);size(1023)" json:"cluster"`
	Severity    string `orm:"column(severity);size(1023)" json:"severity"`
	Type        string `orm:"column(type);size(1023)" json:"type"`
	ProjectName string `orm:"column(project_name);size(1023)" json:"project_name"`
	AppName     string `orm:"column(app_name);size(1023)" json:"app_name"`
	Env         string `orm:"column(env);size(1023)" json:"env"`
